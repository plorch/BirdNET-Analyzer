...
# To save the spectrogram, try this with a name that is descriptive
# For example, 'common name_confidence_row number.pdf'
dev.print(pdf, file.path(o.results, "Titmouse.pdf"))
