...
birdnet.path = "C:/Users/COO/AppData/Local/Programs/BirdNET-Analyzer/BirdNET-Analyzer.exe"

# Single dir of .wav files
# *** Warning: *** Change things here, especially num.threads:
i.audio = file.path("D:","MDLT AudioMoth", 
                    "FreemanCanyonSpring", 
                    "FC1", "FC1_20221016_undone") # version for a folder with .wav files
...
write.csv(highconf_verified_sgcnetc_rows, 
          file.path(o.results, 
                    paste0(basename(o.results), 
                           "highconf_verified_sgcnetc_rows.csv")))
...
i.list = list.files(i.audio, pattern = ".WAV") #".wav"
